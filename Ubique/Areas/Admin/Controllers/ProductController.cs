	...
	public class ProductController : Controller
	{
		...
		public IActionResult Upsert(ProductVM productVM, List<IFormFile> files)
		{
			if (productVM.Product.IsValid()) // TODO: ModelState.IsValid is a better option
			{
				...
				TempData["success"] = productVM.Product.Name + " It's a new product.";
		...
		public IActionResult Edit(Product product)
		{
			if (ModelState.IsValid)
			{
				...
				_unitOfWork.Save();
				TempData["success"] = product.Name + " It has been updated.";
				return RedirectToAction("Index");
			}
		...
		public IActionResult Delete(int? id)
		{
			...
			return Json(new { success = true, message = productToBeDeleted.Name + " it has been cancelled." });
		}
		#endregion
	}
}